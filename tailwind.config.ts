    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          ...
          "50%": { boxShadow: "0 0 50px hsl(217 91% 60% / 0.4), 0 0 30px hsl(263 70% 58% / 0.2)" },
        },
        "neon-pulse": {
          "0%, 100%": { opacity: "0.4" },
          "50%": { opacity: "1" },
      ...
      animation: {
        ...
        "marquee-left-slow": "marquee-left-slow 30s linear infinite",
        "marquee-right-slow": "marquee-right-slow 35s linear infinite",
      },
    },
  },
