  ...
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="container relative z-10 text-center">
        ...
        >
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight mb-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a href="#contact" className="btn-cta text-lg !px-12 !py-4 inline-flex items-center gap-2 group animate-pulse-glow">
              Contact Us Now
